...
class XQSTests
{
	...
	{
		if ( ! class_exists( "\lyquidity\XPath2\XPath2Parser.php", true ) )
		{
			require_once XPATH20_LIBRARY_PATH . 'XPath2Parser.php';
		}
		...
		XQSTests::$conformanceBase = CONFORMANCE_SUITE_BASE;
